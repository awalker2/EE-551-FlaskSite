...
classList = [[],
             ...
             ['Humanity:HUM2', 'MA 134', 'Technical:E 232', 'E 232L', 'E 234', 'E 234R', 'CPE 360', 'CPE 390L', 'CPE 390'],
...
def cpePage2(transcriptList, classList, email, fileName):        
        firstTerm = 0
        try:
        ...
        for semester in classList:
                ...
                for clss in semester:
                        ...
                        if " CPE-345" in clss[1]:
                                CPE345_grade =clss[2]
                                #print CPE345_grade
                                CPE345_term=writeTerm(counter,firstTerm)
                                #print CPE345_term
                        if " CPE-322" in clss[1]:
                                CPE322_grade =clss[2]
                                #print CPE322_grade
                                CPE322_term=writeTerm(counter,firstTerm)
                                #print CPE322_term
        ...
        #term6 grades
        can.drawString(295,332, CPE322_grade)
        can.drawString(295,320, CPE345_grade)
        ...
        #term8
        can.drawString(360,332, CPE424_term)
        ...
        #term8 grades
        can.drawString(620,332, CPE424_grade)
...
cpePage2(transcriptList, classList, "", "")
